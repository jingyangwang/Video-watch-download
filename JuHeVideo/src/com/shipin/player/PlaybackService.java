...
import com.shipin.player.gui.audio.AudioUtil;
...
import com.shipin.player.widget.VLCAppWidgetProvider;
    ...
    private void showNotification() {
        ...
        try {
            ...
            if (canSwitchToVideo()) {
                ...
                final Intent notificationIntent = new Intent(PlaybackService.this, MyFragment.class);
