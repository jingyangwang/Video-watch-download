...
import com.shipin.player.gui.DividerItemDecoration;
...
import com.shipin.player.gui.dialogs.CommonDialogs;
...
import com.shipin.player.util.VLCRunnable;
import com.shipin.player.util.WeakHandler;
import com.shipin.player.widget.ContextMenuRecyclerView;
...
public abstract class BaseBrowserFragment extends MediaBrowserFragment implements IRefreshable, MediaBrowser.EventListener, SwipeRefreshLayout.OnRefreshListener {
    protected static final String TAG = "video/BaseBrowserFragment";
...
//      mRecyclerView.addOnScrollListener(mScrollListener);
    ...
    public void browse (MediaWrapper media, int position, boolean save){
        ...
        SharedPreferencesUtils.setParam(getActivity(), "position", position+"");
...
//        ft.replace(R.id.fragment_placeholder, next, media.getLocation());
    ...
    protected void focusHelper() {
        ...
        MyFragment main = (MyFragment) getActivity();
