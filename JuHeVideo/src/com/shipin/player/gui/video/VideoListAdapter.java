...
import com.shipin.player.util.BitmapCache;
import com.shipin.player.util.BitmapUtil;
...
public class VideoListAdapter extends ArrayAdapter<MediaWrapper>
    ...
    public VideoListAdapter(VideoGridFragment fragment) {
        ...
        mFragment = fragment;
        editFunction = fragment.getActivity().getSharedPreferences("jmydata", fragment.getActivity().MODE_WORLD_WRITEABLE);
    }
...
//            }
            ...
            holder.select = (ImageView) v.findViewById(R.id.ml_item_select);
        ...
        if(videoShow.equals("1")){
        	...
        	getItem(position).setSelState(false);
        }
