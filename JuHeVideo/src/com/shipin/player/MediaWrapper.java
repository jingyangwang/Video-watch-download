...
public class MediaWrapper implements Parcelable {
     ...
     * due to lazy-loading.
     *
     * Use {@link com.shipin.player.util.BitmapUtil#getPictureFromCache(MediaWrapper)} instead.
     *
     ...
     *
     * In VLC for Android, use {@link com.shipin.player.MediaDatabase#setPicture(MediaWrapper, Bitmap)} instead.
     *
     * @param p
     */
	...
	public boolean isSelState() {
		return selState;
	}

	public void setSelState(boolean selState) {
		this.selState = selState;
	}

	@Override
	public String toString() {
		return "MediaWrapper [mTitle=" + mTitle + ", mArtist=" + mArtist
				+ ", mGenre=" + mGenre + ", mCopyright=" + mCopyright
				+ ", mAlbum=" + mAlbum + ", mTrackNumber=" + mTrackNumber
				+ ", mDiscNumber=" + mDiscNumber + ", mAlbumArtist="
				+ mAlbumArtist + ", mDescription=" + mDescription
				+ ", mRating=" + mRating + ", mDate=" + mDate + ", mSettings="
				+ mSettings + ", mNowPlaying=" + mNowPlaying + ", mPublisher="
				+ mPublisher + ", mEncodedBy=" + mEncodedBy + ", mTrackID="
				+ mTrackID + ", mArtworkURL=" + mArtworkURL + ", mUri=" + mUri
				+ ", mFilename=" + mFilename + ", mTime=" + mTime
				+ ", mAudioTrack=" + mAudioTrack + ", mSpuTrack=" + mSpuTrack
				+ ", mLength=" + mLength + ", mType=" + mType + ", mWidth="
				+ mWidth + ", mHeight=" + mHeight + ", mPicture=" + mPicture
				+ ", mIsPictureParsed=" + mIsPictureParsed + ", mFlags="
				+ mFlags + ", mLastModified=" + mLastModified + "]";
	}
