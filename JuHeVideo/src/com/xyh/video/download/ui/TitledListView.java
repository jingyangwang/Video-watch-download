...
public class TitledListView extends ListView {
	...
	public void setAdapter(ListAdapter adapter) {
		...
		mTitle = inflater.inflate(R.layout.download_listview_title, this, false);
	}
	...
	void updateTitle(String title) {
		if (title != null) {
			TextView title_text = (TextView) mTitle.findViewById(R.id.titled_text);
			title_text.setText(title);
		}
		mTitle.layout(0, 0, mTitle.getMeasuredWidth(), mTitle.getMeasuredHeight());
	}

	void updateTitleState(String title) {
		if (title != null) {
			TextView title_text = (TextView) mTitle.findViewById(R.id.titled_text);
			title_text.setText(title);
		}
