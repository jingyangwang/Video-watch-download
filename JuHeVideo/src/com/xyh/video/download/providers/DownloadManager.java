...
package com.xyh.video.download.providers;
...
public class DownloadManager {
	 ...
	 * 
	 * @see <a href=
	 *      "http://www.w3.org/Protocols/rfc2616/rfc2616-sec6.html#sec6.1.1">RFC
	 *      2616 status codes</a>
	 */
	...
	private static final String[] COLUMNS = new String[] { COLUMN_ID, COLUMN_TITLE, COLUMN_DESCRIPTION, COLUMN_URI, COLUMN_MEDIA_TYPE, COLUMN_TOTAL_SIZE_BYTES,
			COLUMN_LOCAL_URI, COLUMN_STATUS, COLUMN_REASON, COLUMN_BYTES_DOWNLOADED_SO_FAR, COLUMN_LAST_MODIFIED_TIMESTAMP };

	// columns to request from DownloadProvider
	private static final String[] UNDERLYING_COLUMNS = new String[] { Downloads._ID, Downloads.COLUMN_TITLE, Downloads.COLUMN_DESCRIPTION, Downloads.COLUMN_URI,
			Downloads.COLUMN_MIME_TYPE, Downloads.COLUMN_TOTAL_BYTES, Downloads.COLUMN_STATUS, Downloads.COLUMN_CURRENT_BYTES,
	...
	private static final Set<String> LONG_COLUMNS = new HashSet<String>(
			Arrays.asList(COLUMN_ID, COLUMN_TOTAL_SIZE_BYTES, COLUMN_STATUS, COLUMN_REASON, COLUMN_BYTES_DOWNLOADED_SO_FAR, COLUMN_LAST_MODIFIED_TIMESTAMP));
	...
	public static class Request {
		 ...
		 * @return this object
		 */
		public Request setDestinationInExternalPublicDir(String dir, String subPath) {
			setDestinationFromBase(new File(dir), subPath);
			return this;
		}
		 ...
		 * {@link io.github.mthli.Ninja.Download.providers.NotificationManager}. By default,
	...
	public long enqueue(Request request) {
		...
		Log.i("AAAA", "downloadUri"+downloadUri);
