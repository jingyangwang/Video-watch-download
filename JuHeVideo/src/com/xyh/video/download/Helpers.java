...
public class Helpers {
	 ...
	 * download.
	 */
	public static String generateSaveFile(Context context, String url, String hint,String des, String contentDisposition, String contentLocation, String mimeType,
			int destination, long contentLength, boolean isPublicApi) throws GenerateSaveFileError {
		checkCanHandleDownload(context, mimeType, destination, isPublicApi);
		if (destination == Downloads.DESTINATION_FILE_URI) {
			return getPathForFileUri(url, hint, des,contentDisposition, contentLocation, mimeType, destination, contentLength);
		} else {
			return chooseFullPath(context, url, hint, des,contentDisposition, contentLocation, mimeType, destination, contentLength);
		}
	}

	private static String getPathForFileUri(String url, String hint, String des,String contentDisposition, String contentLocation, String mimeType, int destination,
		...
		if (path.endsWith("/")) {
			...
			path = generateFilePath(basePath, url, des,contentDisposition, contentLocation, mimeType, destination, contentLength);
	...
	private static String generateFilePath(String basePath, String url,String des, String contentDisposition, String contentLocation, String mimeType, int destination,
			long contentLength) throws GenerateSaveFileError {
		String filename = des;
	...
	private static String chooseFullPath(Context context, String url, String des,String hint, String contentDisposition, String contentLocation, String mimeType,
		...
		return generateFilePath(base.getPath(), url, des,contentDisposition, contentLocation, mimeType, destination, contentLength);
	}
	...
	private static File locateDestinationDirectory(Context context, String mimeType, int destination, long contentLength) throws GenerateSaveFileError {
	...
	private static File getExternalDestination(long contentLength) throws GenerateSaveFileError {
		...
		if (!base.isDirectory() && !base.mkdir()) {
			...
			// read-only.
			throw new GenerateSaveFileError(Downloads.STATUS_FILE_ERROR, "unable to create external downloads directory " + base.getPath());
		}
		return base;
	}
