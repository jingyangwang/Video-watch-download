...
//        setContentView(R.layout.set_preference_extra); 
        ...
        // 20151026 liukedong 添加 隐藏视频checkbox
        final CheckBoxPreference checkboxHidden = (CheckBoxPreference) findPreference("enable_hidden");
        checkboxHidden.setOnPreferenceClickListener(
        		new OnPreferenceClickListener() {
        			@Override
        			public boolean onPreferenceClick(Preference preference) {
//        				mService.setIsHiddenVideo(checkboxHidden.isChecked());
        				PreferenceManager.getDefaultSharedPreferences(PreferencesActivity.this).edit().putBoolean(Config.SHARED_PREF_ENABLE_HIDDEN, checkboxHidden.isChecked()).commit();
        				return true;
        			}
        		});

//         Clear hidden history
        Preference clearHistoryPref = findPreference("clear_hidden_history");
                ...
                new OnPreferenceClickListener() {
                    ...
                    public boolean onPreferenceClick(Preference preference) {
                        new AlertDialog.Builder(PreferencesActivity.this)
                                .setTitle(R.string.clear_hidden_history)
...
//                                        db.clearSearchHistory();
                                    	  PreferenceManager.getDefaultSharedPreferences(PreferencesActivity.this).edit().putStringSet(Config.SHARED_PREF_ENABLE_HIDDEN, null).commit();
                                    }
                                })
