...
import com.shipin.player.interfaces.IBrowser;
...
public class AudioBrowserFragment extends MediaBrowserFragment implements SwipeRefreshLayout.OnRefreshListener, MediaBrowser.EventListener, IBrowser, ViewPager.OnPageChangeListener {
    public final static String TAG = "video/AudioBrowserFragment";
    ...
    private void focusHelper(final boolean idIsEmpty, final int listId) {
        ...
        final MyFragment main = (MyFragment)getActivity();
        if (main == null)
            return;
        ...
        public boolean onKey(View v, int keyCode, KeyEvent event) {
            ...
            if (event.getAction() == KeyEvent.ACTION_DOWN) {
                ...
                if (newPosition != mViewPager.getCurrentItem()) {
                    ...
                    ((MyFragment)getActivity()).setSearchAsFocusDown(
