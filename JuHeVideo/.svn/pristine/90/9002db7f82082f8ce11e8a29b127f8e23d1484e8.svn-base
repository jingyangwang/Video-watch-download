...
import com.shipin.player.interfaces.OnEqualizerBarChangeListener;
import com.shipin.player.util.VLCOptions;
import com.shipin.player.widget.EqualizerBar;

public class EqualizerFragment extends PlaybackServiceFragment {

    public final static String TAG = "video/EqualizerFragment";
