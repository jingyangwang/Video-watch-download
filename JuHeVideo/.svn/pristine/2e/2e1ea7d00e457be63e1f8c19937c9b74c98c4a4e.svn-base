package com.example.polymerization.view;

import com.example.polymerization.adapter.DragAdapter;
import com.example.polymerization.tools.DataTools;
...
public class DragGrid extends GridView {
	...
	public boolean onTouchEvent(MotionEvent ev) {
		// TODO Auto-generated method stub
		boolean bool = true;
		if (dragImageView != null && dragPosition != AdapterView.INVALID_POSITION) {//�ж�position���Ƿ���Ч
			// 移动时候的对应x,y位置
...
//		this.windowParams.y = (y - this.win_view_y + this.viewY);//位置的y值ֵ
		//设置拖拽item的宽和高  
