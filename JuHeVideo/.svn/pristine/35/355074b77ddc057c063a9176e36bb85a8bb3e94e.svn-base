...
package com.shipin.player.widget;
...
public class VLCAppWidgetProvider extends AppWidgetProvider {
    public static final String TAG = "video/videoAppWidgetProvider";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (ACTION_WIDGET_INIT.equals(action) || !partial) {
            ...
            Intent iVlc = new Intent(VLCApplication.getAppContext(), MyFragment.class);
